 ...
 * Message Headers: it says "Field names are case-insensitive."
 * That's the why node HTTP sets all headers to lower case automatically.
 */
export const AUTHORIZATION_TOKEN_HEADER = 'authorization' as const;

/**
 * Field names in Cognito JWT token custom claims.
 */
